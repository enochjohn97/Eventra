...
$envKeys = [
    ...
    'GOOGLE_CLIENT_ID', 'GOOGLE_CLIENT_SECRET', 'GOOGLE_REDIRECT_URI', 'GOOGLE_MAPS_API_KEY', 'GOOGLE_CALENDAR_API_KEY', 'GOOGLE_WEBHOOK_SECRET',
    'SENDCHAMP_SECRET_KEY', 'SENDCHAMP_SENDER_ID',
